...
enum GetDataMsg {
    ...
    MSG_QUORUM_DUMMY_COMMITMENT = 22, // only valid on testnet/povnet/regtest
    MSG_QUORUM_DUMMY_CONTRIBUTION = 23, // not a valid contribution and only allowed on testnet/povnet/regtest. Will later be replaced with the real contribution
};
