...
void protx_register_help()
{
    throw std::runtime_error(
            ...
            "8. \"payoutAddress\"       (string, required) The absolute address to use for masternode reward payments\n"
...
UniValue protx_register(const JSONRPCRequest& request)
{
    ...
    if (collateralAmount != 1000 * COIN)
        throw std::runtime_error(strprintf("invalid collateral amount %d. only 1000 ABS is supported at the moment", collateralAmount));
...
void protx_update_registrar_help()
{
    throw std::runtime_error(
            ...
            "5. \"payoutAddress\"       (string, required) The Absolute address to use for masternode reward payments\n"
