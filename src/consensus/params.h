...
enum DeploymentPos
{
    ...
    DEPLOYMENT_AIP0001, // Deployment of AIP0001 and lower transaction fees.
...
// See https://github.com/dashpay/aips/blob/master/aip-0006.md for more details
struct LLMQParams {
    LLMQType type;
...
struct Params {
    ...
    uint256 hashPoVNETGenesisBlock;
    ...
    int BIP66Height;
    /** Block height at which AIP0001 becomes active */
    int AIP0001Height;
    /**
    ...
    /** these parameters are only used on povnet and can be configured from the outside */
